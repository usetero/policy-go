...
func TestKeepRestrictiveness(t *testing.T) {
	tests := []struct {
		...
		{"KeepRatePerSecond is medium", Keep{Action: KeepRatePerSecond, Value: 10, Duration: 1}, 500},
		{"KeepRatePerMinute is medium", Keep{Action: KeepRatePerMinute, Value: 100, Duration: 1}, 500},
...
func TestParseKeep(t *testing.T) {
	tests := []struct {
		...
		{"100/s", "100/s", Keep{Action: KeepRatePerSecond, Value: 100, Duration: 1}, false},
		{"1000/m", "1000/m", Keep{Action: KeepRatePerMinute, Value: 1000, Duration: 1}, false},
		{"1/5s", "1/5s", Keep{Action: KeepRatePerSecond, Value: 1, Duration: 5}, false},
		{"1/300s", "1/300s", Keep{Action: KeepRatePerSecond, Value: 1, Duration: 300}, false},
		{"10/5m", "10/5m", Keep{Action: KeepRatePerMinute, Value: 10, Duration: 5}, false},
		{"float count rejected", "1.5/s", Keep{}, true},
		{"float count rejected with duration", "1.5/5s", Keep{}, true},
		{"zero count rejected", "0/s", Keep{}, true},
		{"zero duration rejected", "1/0s", Keep{}, true},

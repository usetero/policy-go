...
import (
	v1development "go.opentelemetry.io/proto/otlp/profiles/v1development"
...
const file_opentelemetry_proto_collector_profiles_v1development_profiles_service_proto_rawDesc = "" +
	...
	"\x06Export\x12R.opentelemetry.proto.collector.profiles.v1development.ExportProfilesServiceRequest\x1aS.opentelemetry.proto.collector.profiles.v1development.ExportProfilesServiceResponse\"\x00B\xc9\x01\n" +
	"7io.opentelemetry.proto.collector.profiles.v1developmentB\x14ProfilesServiceProtoP\x01Z?go.opentelemetry.io/proto/otlp/collector/profiles/v1development\xaa\x024OpenTelemetry.Proto.Collector.Profiles.V1Developmentb\x06proto3"
